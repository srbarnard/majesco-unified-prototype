...
export const tasksMock: TaskRecord[] = [
  ...
  {
    id: 't-11',
    taskName: 'Approve renewal pricing',
    assigner: 'Leslie Neuman',
    assignedTo: 'Assigned to me',
    priority: 'Medium',
    status: 'Pending',
  ...
  {
    id: 't-12',
    taskName: 'Bind endorsement – additional insured',
    assigner: 'Alex Carter',
    assignedTo: 'Jasmine Nguyen',
    priority: 'High',
    status: 'Started',
  ...
  {
    id: 't-13',
    taskName: 'Request updated loss runs',
    assigner: 'Chris Reynolds',
    assignedTo: 'Brenda Holmes',
    priority: 'High',
    status: 'Pending',
  ...
  {
    id: 't-14',
    taskName: 'Review referred quote – WC',
    assigner: 'Pamela Hollingsworth',
    assignedTo: 'Kevin Ortiz',
    priority: 'Medium',
    status: 'Started',
  ...
  {
    id: 't-15',
    taskName: 'Follow up on missing FNOL documents',
    assigner: 'Dana Patel',
    assignedTo: 'Landon Wilson',
    priority: 'High',
    status: 'Pending',
  ...
  {
    id: 't-16',
    taskName: 'Send binder to producer',
  ...
  {
    id: 't-17',
    taskName: 'Complete mid-term audit review',
    assigner: 'Brenda Holmes',
    assignedTo: 'Chris Reynolds',
    priority: 'Medium',
    status: 'Suspended',
    ...
    dueDate: '2026-06-20',
    assignedLabel: 'Jun 10, 2026',
    dueLabel: 'Past due',
    refNumber: '01-WC-000045201-0',
    referenceType: 'Policy',
    agingDays: 16,
    isPastDue: true,
  },
  {
    id: 't-18',
    taskName: 'Verify billing installment schedule',
    assigner: 'Jasmine Nguyen',
    assignedTo: 'Brianna Lopez',
    priority: 'Low',
    status: 'Started',
    assignedDate: '2026-06-26',
    dueDate: '2026-07-01',
  ...
  {
    id: 't-19',
    taskName: 'Underwriting referral – fleet expansion',
    assigner: 'Landon Wilson',
    assignedTo: 'Leslie Neuman',
    priority: 'High',
    status: 'Unassigned',
  ...
  {
    id: 't-20',
    taskName: 'Close out completed inspection task',
    assigner: 'Kevin Ortiz',
    assignedTo: 'Dana Patel',
    priority: 'Low',
    status: 'Completed',
    assignedDate: '2026-06-20',
